            ...
            <div class="col-lg-12 mb-4 order-1">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="<?= BASE_URL ?>pembayaran/suplier" class="me-2">
                    ...
                    <div class="card-body">
                        <form id="frmCicilan" action="<?= BASE_URL ?>pembayaran/inputCicilan_suplier" method="POST">
                            <div class="row row-cols-2">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="barang">Suplier</label>
                                    <div class="input-group input-group-merge">
                                        <input id="suplier" type="text" name="suplier" class="form-control" value="<?= old('pelanggan') ?>" readonly>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" name="keterangan" id="keterangan" class="form-control" value="<?= old('keterangan') ?>" disabled>
                                    </div>
                                </div>
                                <div hidden>
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="number" name="notabeli" id="notabeli" placeholder="Masukkan Nominal" class="form-control" value="<?= old('notajual') ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="barang">Nota Retur</label>
                                        <div class="input-group input-group-merge">
                                            <input type="number" name="id_notaretur" id="id_notaretur" class="form-control" readonly required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
