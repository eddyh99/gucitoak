...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <?php if ($isAdmin || isset($akses->setup)): ?>
            ...
            <!-- submenu -->
            <ul id="submenuSetup" class="collapse ps-3">
        ...
        <?php if ($isAdmin || isset($akses->persediaan)): ?>
            ...
            <!-- submenu -->
            <ul id="submenuPersediaan" class="collapse ps-3">
        ...
        <?php if ($isAdmin || isset($akses->transaksi)): ?>
            ...
            <!-- Submenu -->
            <ul id="submenuTransaksi" class="collapse ps-3">
        ...
        <?php if ($isAdmin || isset($akses->laporan)): ?>
            ...
            <!-- submenu -->
            <ul id="submenuLaporan" class="collapse ps-3">
