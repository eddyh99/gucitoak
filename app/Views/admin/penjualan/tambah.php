            ...
            <div class="col-lg-12 mb-4 order-1">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="<?= BASE_URL ?>penjualan" class="me-2">
                    ...
                    <div class="card-body">
                        <form id="frmjual" action="<?= BASE_URL ?>penjualan/simpanpenjualan" method="POST">
                            <div class="row row-cols-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <select name="sales" id="sales" class="form-select" required>
                                            <option></option>
                                    ...
                                    <select id="pelanggan" name="pelanggan" class="form-select" required>
                                        ...
                                        <?php foreach ($pelanggan as $p) : ?>
                                            <option
                                                ...
                                                data-totalnotacount="<?= $p->total_nota_count; ?>"
                                                data-plafon="<?= $p->plafon; ?>"
                                                data-totalnotavalue="<?= $p->total_nota_value; ?>"
                                                data-harganota="<?= $p->harga; ?>">
                                                <?= $p->namapelanggan ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                        ...
                                        <table id="preview_stok" class="table table-striped" style="width:100%">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="diskon" class="form-control form-control-sm" placeholder="-" min="0" style="width: 145px;"></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1">
                                                            <input type="number" id="ppn" class="form-control form-control-sm" placeholder="0%" min="0" max="100" style="width: 70px;">
