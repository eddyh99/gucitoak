                        ...
                        <div class="col-lg-12 col-md-12 col-12 mb-2">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center">
                                    <a href="<?= BASE_URL?>cabang/tambah_cabang" class="btn btn-primary d-flex align-items-center">
                                        <i class="tf-icons bx bx-plus"></i> Cabang
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-10 mb-4 order-1">
                    <div class="card border-expat w-100">
                        <div class="card-body">
                            ...
                            <table id="table_list_cabang" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Cabang</th>
                                        <th>Alamat</th>
